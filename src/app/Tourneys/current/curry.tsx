...
export default function THINGY4() {
  const [second_page, setsecond_page] = useState(false);
  ...
  useEffect(() => {
    const hello = async () => {
      ...
      for (let i = 0; i < result_2.length; i++) {
        if (result_2[i].ref === selectedresult) {
  ...
  useEffect(() => {
    ...
    const hello = async () => {
      ...
      setResult_2(results_2y);
      // if (results_2y[0].name.includes("Date")) {
      //   setresultsexiste(false);
      // } else {
      //   setresultsexiste(true);
      // }
      if (results_2y.length === 0) {
        setsecond_page(false);
      } else {
        setsecond_page(true);
        setSelectedResult(results_2y[0].ref);
      }
    };
    hello();
  }, [curr_result_event]);
    ...
    const hello = async () => {
      ...
      const invite_thing =
        (await page_render
          .replaceAll(
            "<p>",
            "<p style='color: " + (light_dark ? "#ffffff" : "#000000") + "; '>",
          )
          .replaceAll(
            '<p style="',
            '<p style="color: ' + (light_dark ? "#ffffff" : "#000000") + "; '>",
                  ...
                  source={{
                    ...
                    html: `
                                ...
                                <html>
                                  ...
                                  <body>
                                    ${invite_data.replaceAll("<p", "<p style='color: " + (light_dark ? "white" : "black") + ";'")}
                                  </body>
                                </html>
  `,
                  }}
  ...
  `,
            ...
            return (
              <>
                ...
                <ScrollView
                  style={{ display: pairing_page_existe ? "flex" : "none" }}
                >
                  <TextInput
                    style={{
                      marginLeft: 20,
            ...
            return (
              <>
                ...
                <ScrollView style={{ display: second_page ? "flex" : "none" }}>
                  <TextInput
                    style={{
                      marginLeft: 20,
                      borderWidth: 1,
